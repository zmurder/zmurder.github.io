...
![image-20230209142354923](杂.assets/image-20230209142354923.png)
...
![image-20230209145003063](杂.assets/image-20230209145003063.png)
...
![image-20230209143501037](杂.assets/image-20230209143501037.png)
...
![image-20230209144128737](杂.assets/image-20230209144128737.png)

日志文件生成后就可以使用官方提供的`notebooks/engine_report_card.ipynb`文件进行分析了。这里参考复制了一份，并修改为自己的模型文件。

![image-20230209144546060](杂.assets/image-20230209144546060.png)

一步一步就可以运行了，其中`Render Graph`就是生成engine文件模型结构图片后缀是`.svg`，提示存放的路经。这里截取一部分图片如下

![image-20230209144727973](杂.assets/image-20230209144727973.png)
...
![image-20230209145430819](杂.assets/image-20230209145430819.png)
...
![image-20230209152635547](杂.assets/image-20230209152635547.png)
...
![image-20230209154709003](杂.assets/image-20230209154709003.png)

![dY4D](杂.assets/dY4D.gif)
